 ...
 * @return
 */
export function createPath(path: string, attrs: any, OUTLINE_STYLE: any): SVGElement;
...
export const DATA_OBJECT_REFERENCE_STANDARD_SIZE: Dimensions;
export const DATA_STORE_REFERENCE_STANDARD_SIZE: Dimensions;
