export default class LabelEditingProvider {
   ...
   * @param textRenderer
   */
  constructor(eventBus: EventBus, bpmnFactory: BpmnFactory, canvas: Canvas, directEditing: DirectEditing, modeling: Modeling, resizeHandles: ResizeHandles, textRenderer: TextRenderer);
...
//# sourceMappingURL=LabelEditingProvider.d.ts.map