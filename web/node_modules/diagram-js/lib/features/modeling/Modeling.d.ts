 ...
 *
 */
export default class Modeling<T extends Connection = import("../../model/Types.js").Connection, U extends Element = import("../../model/Types.js").Element, V extends Label = import("../../model/Types.js").Label, W extends Parent = import("../../model/Types.js").Parent, X extends Shape = import("../../model/Types.js").Shape> {
...
type Label = import("../../model/Types.js").Label;
type CommandStack = import("../../command/CommandStack.js").default;
type ElementFactory = import("../../core/ElementFactory.js").default;
type EventBus = import("../../core/EventBus.js").default;
type CommandHandlerConstructor = import("../../command/CommandStack.js").CommandHandlerConstructor;
...
export type ModelingDistributeGroup<U extends Element> = {
    elements: U[];
    range: {
        min: number;
        max: number;
