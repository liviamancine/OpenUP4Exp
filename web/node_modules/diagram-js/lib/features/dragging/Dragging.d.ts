...
export default class Dragging {
  ...
  init(prefix: string, options?: any): boolean;
  init(relativeTo: Point, prefix: string, options?: any): boolean;
  init(event: MouseEvent | TouchEvent, prefix: string, options?: any): boolean;
...
type Selection = import("../selection/Selection.js").default;