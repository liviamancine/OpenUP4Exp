...
export type PopupMenuEntryAction = (event: Event, entry: PopupMenuActionEntry, action?: string) => any;
...
export type PopupMenuEntry = PopupMenuActionEntry | PopupMenuStepEntry;
...
export {};
//# sourceMappingURL=PopupMenuProvider.d.ts.map