...
export default class ContextPad {
   ...
   * @param scheduler
   */
  constructor(canvas: Canvas, elementRegistry: ElementRegistry, eventBus: EventBus, scheduler: Scheduler);
...
type Scheduler = import("../scheduler/Scheduler.js").default;
type ContextPadProvider = import("./ContextPadProvider.js").default;
type ContextPadEntries = import("./ContextPadProvider.js").ContextPadEntries;

export type ContextPadTarget<ElementType extends Element = import("../../model/Types.js").Element> = ElementType | ElementType[];
//# sourceMappingURL=ContextPad.d.ts.map