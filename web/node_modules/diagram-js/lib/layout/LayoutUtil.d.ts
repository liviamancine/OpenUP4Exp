...
export function getIntersections(a: any, b: any): import("path-intersection", { with: { "resolution-mode": "import" } }).Intersection[];
export function filterRedundantWaypoints(waypoints: any): any;
type Element = import("../core/Types.js").ElementLike;
type Connection = import("../core/Types.js").ConnectionLike;
type DirectionTRBL = import("../util/Types.js").DirectionTRBL;
type Intersection = import("../util/Types.js").Intersection;
