...
export default class Canvas {
   ...
   */
  findRoot(element: ElementOrIdentifier | ElementOrIdentifier[]): RootLike | undefined;
   ...
   *
   * @param element The element(s) to scroll to or their ID(s).
   * @param padding The padding to be applied. Can also specify top, bottom, left and right.
   */
  scrollToElement(element: ElementOrIdentifier | ElementOrIdentifier[], padding?: RectTRBL | number): void;
...
type ConnectionLike = import("./Types.js").ConnectionLike;
type RootLike = import("./Types.js").RootLike;
type ParentLike = import("./Types.js").ParentLike;
type ShapeLike = import("./Types.js").ShapeLike;
export type ElementOrIdentifier = ShapeLike | ConnectionLike | RootLike | string;
...
type ElementRegistry = import("./ElementRegistry.js").default;
type EventBus = import("./EventBus.js").default;
type GraphicsFactory = import("./GraphicsFactory.js").default;
type Dimensions = import("../util/Types.js").Dimensions;
type Point = import("../util/Types.js").Point;
type Rect = import("../util/Types.js").Rect;
type RectTRBL = import("../util/Types.js").RectTRBL;
type ScrollDelta = import("../util/Types.js").ScrollDelta;